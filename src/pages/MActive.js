...
const MActive = () => {
  ...
  const [FutureBox1, setFutureBox1] = useState(false);
  const [ExpiredBox1, setExpiredBox1] = useState(false);
  return (
    <>
            ...
            <div className="dashbrd_cont">
              ...
              <div className="dashbrd_cont profile-details">
                <div className="profile-det-titls">
                  <h3 className="PremiumAccount">METAVERSE LISTINGS</h3>
                        ...
                        <table className="activeTable mt-4 mb-5">
                          <thead>
                            <tr>
                              ...
                              <th className="ActTh">Package Type</th>
                          ...
                          <tbody className="ActTBody">
                            <tr>
                              ...
                              <td className="ActTd">PLATFORM ONLY</td>
                            ...
                            <tr>
                              ...
                              <td className="ActTd">PLATFORM + PROMOTION</td>
                              <td className="ActTd">11-11-2023</td>
                              <td className="ActTd">11-11-2023</td>
                            </tr>
                            <tr>
                      ...
                      <div className="packSection">
                        ...
                        <table className="ExpiredTable mt-4 mb-5">
                          <thead>
                            ...
                            <th className="ExpiredTh">Package Type</th>
                          ...
                          <tbody className="ExpiredBody">
                            <tr>
                              ...
                              <td className="ExpiredTd">PLATFORM ONLY</td>
                            ...
                            <tr>
                              ...
                              <td className="ExpiredTd">PLATFORM + PROMOTION</td>
                              <td className="ExpiredTd">11-11-2023</td>
                              <td className="ExpiredTd">11-11-2023</td>
                            </tr>
                            <tr>
                      ...
                      <div className="packSection">
                        ...
                        <table className="FutureTable mt-4 mb-5">
                          <thead>
                            ...
                            <th className="FutureTh">Package Type</th>
                          ...
                          <tbody className="FutureTBody">
                            <tr>
                              ...
                              <td className="FutureTd">PLATFORM ONLY</td>
                            ...
                            <tr>
                              ...
                              <td className="FutureTd">PLATFORM + PROMOTION</td>
                              <td className="FutureTd">11-11-2023</td>
                              <td className="FutureTd">11-11-2023</td>
                            </tr>
                            <tr>
