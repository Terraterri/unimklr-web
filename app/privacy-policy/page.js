  ...
  <div class="auto-container">
    <div class="inner-container">
      <div class="row align-items-center">
        ...
        <p class="last text-right"> Last updated: May 30, 2024 </p>
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to UNIMAKLER REALTORS PRIVATE LIMITED, Hyderabad, Telangana.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to unimakler, accessible from <a href="https://unimakler.com/" rel="external nofollow noopener" target="_blank">https://unimakler.com/</a>
            </p>
          </li>
          <li>
            <p>
        ...
        <p> Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies on the <a href="https://www.freeprivacypolicy.com/blog/sample-privacy-policy-template/#
Use_Of_Cookies_And_Tracking" target="_blank">Free Privacy Policy website</a> article. </p>
        ...
        <ul>
          <li> By email: <a href="mailto:info@unimakler.com">info@unimakler.com</a>
          </li>
        </ul>
      </div>
    </div>
